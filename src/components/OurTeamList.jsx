...
const TeamData = [
  {
    ...
    description:
      "Jamsheed manages the daily operations of Firstclusive, ensuring that all departments work in harmony to achieve our business goals.",
    message_from:
  ...
  },
  {
    ...
    message_from:
      "I work tirelessly to support the team in meeting their goals and ensuring smooth and efficient operations across all projects.",
  },
  {
    id: 5,
